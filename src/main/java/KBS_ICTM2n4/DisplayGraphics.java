...
public class DisplayGraphics extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        //Hieronder initaliseer ik een paar variabelen die gebruikt worden om de rectangle etc te tekenen
        DServerY = 360;
        WServerY = 0;
        wserverIp = 2;
        dserverIp = 7;
        ...
        if(aDatabaseServers1 > 0 ||aDatabaseServers2 > 0 ||aDatabaseServers3 > 0){
            ...
            g.drawString("192.168.1.-",databaseGroupBegin+((databaseGroupEnd-databaseGroupBegin)/2)-30,DServerY+20);//Ip addres van db servers
        }
        i=0;    //initializer voor While-loop
