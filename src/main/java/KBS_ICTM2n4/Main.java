...
//        Screen.dropdownitemsedit.add("test2");
        ...
        /*
         * Server server1 = new Server("database", "db1", 0.90, 2500); Server server2 =
         * new Server("database", "db2", 0.95, 2500); Server server3 = new
         * Server("database", "db3", 0.98, 2500); Server server4 = new
         * Server("webserver", "web1", 0.80, 2500); Server server5 = new
